...
The notes about seed setting and clearing are **especially** important if you want to be able to use the same data in multiple `meow` simulations without fixing the seeds for all subsequent analysis!